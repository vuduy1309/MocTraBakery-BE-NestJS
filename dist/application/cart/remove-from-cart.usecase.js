...
let RemoveFromCartUseCase = class RemoveFromCartUseCase {
    ...
    async execute(userId, productId, size) {
        return this.cartRepo.updateOne({ userId: new mongoose_1.Types.ObjectId(userId) }, { $pull: { items: { productId: new mongoose_1.Types.ObjectId(productId), size } } });
    }
};
exports.RemoveFromCartUseCase = RemoveFromCartUseCase;
exports.RemoveFromCartUseCase = RemoveFromCartUseCase = __decorate([
